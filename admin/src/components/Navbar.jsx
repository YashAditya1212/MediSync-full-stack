...
const Navbar = () => {
  ...
  const navItems = useMemo(() => ([
    { label: 'DASHBOARD', path: isAdmin ? '/admin-dashboard' : '/doctor-dashboard' },
    { label: 'APPOINTMENTS', path: isAdmin ? '/all-appointments' : '/doctor-appointments' },
    ...(isAdmin ? [
      { label: 'ADD NEW DOCTOR', path: '/add-doctor' },
      { label: 'DOCTORS LIST', path: '/doctor-list' },
    ] : [
