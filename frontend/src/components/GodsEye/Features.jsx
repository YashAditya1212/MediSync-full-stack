    ...
    <section className="py-20 relative">
      <MaxWidthContainer>
        <div className="text-center mb-16 space-y-4">
          <h2 className="font-bold text-4xl md:text-5xl text-text-main font-display">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-text-main mb-2">{singleFeature.title}</h3>
                    <p className="text-text-muted text-sm leading-relaxed">{singleFeature.description}</p>
                  </div>
                </div>
              </div>
            );
