    ...
    <section className="py-20 relative">
      <MaxWidthContainer>
        <div className="text-center mb-16 space-y-4">
          <h2 className="font-bold text-4xl md:text-5xl text-text-main font-display dark:text-stone-500">
            Advanced Capabilities
          </h2>
          <p className="text-text-muted max-w-2xl mx-auto text-lg dark:text-teal-300">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {allFeatures.map((singleFeature, index) => {
            return (
              ...
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -mr-16 -mt-16 transition-all group-hover:scale-150 group-hover:bg-primary/10"></div>
                
                <div className="relative z-10 space-y-6">
                  <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 shadow-lg shadow-primary/20">
                    <singleFeature.icon className="w-8 h-8" />
                  </div>
                  
                  <div>
                    <h3 className="text-xl font-bold text-text-main mb-2 dark:text-green-200" >{singleFeature.title}</h3>
                    <p className="text-text-muted text-sm leading-relaxed dark:text-teal-400">{singleFeature.description}</p>
                  </div>
                </div>
              </div>
            );
