        ...
        <div className='glass-panel p-1 rounded-2xl my-20 md:mx-10 shadow-card-hover overflow-hidden'>
            <div className='flex bg-gradient-to-r from-primary to-accent rounded-xl px-6 sm:px-10 md:px-14 lg:px-12'>
                ...
                <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
                    ...
                    <button onClick={() => { navigate('/login'); scrollTo(0, 0) }} className='glass-panel bg-white/90 text-primary text-sm sm:text-base font-semibold px-8 py-4 rounded-full mt-6 hover:scale-105 hover:shadow-lg transition-all'>Create account</button>
                </div>
