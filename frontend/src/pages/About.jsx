...
const About = () => {
  return (
    <div>
      ...
      <div className='glass-panel p-8 rounded-3xl my-10 flex flex-col md:flex-row gap-12'>
      ...
      <div className='flex flex-col md:flex-row mb-20 gap-4'>
        <div className='glass-card px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-text-medium cursor-pointer rounded-xl hover:shadow-card-hover hover:scale-105'>
