...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <div className='glass-panel p-8 rounded-3xl my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <button className='glass-panel border-none text-primary px-8 py-3 text-sm font-semibold hover:bg-primary hover:text-white transition-all duration-300 rounded-full shadow-md hover:shadow-lg'>Explore Jobs</button>
        </div>
      </div>
